...
export const seoFields = [
  ...
  defineField({
    ...
    description:
      'This will override the meta description. If left blank it will inherit the page description.',
    type: 'text',
    rows: 2,
    validation: (rule) => [
  ...
  defineField({
    ...
    description:
      'This will override the default image for the page. If left blank it will inherit the page image.',
    type: 'image',
    group: GROUP.SEO,
    options: {
      hotspot: true,
